...
/***/ function(module, exports, __webpack_require__) {
	...
	domready(function () {
	  ...
	  .run(function (Handler, state) {
	    ReactDOM.render(React.createElement(Handler, null), document.getElementById('content-section'));
	    //analytics(state);
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireDefault = __webpack_require__(204)['default'];
	...
	var _masterJsx = __webpack_require__(205);

	var _masterJsx2 = _interopRequireDefault(_masterJsx);

	var AppRoutes = [];

	AppRoutes.push(_react2['default'].createElement(_reactRouter.Route, { name: 'root', path: '/', handler: _masterJsx2['default'] }));
